...
func (r *RDB) runScript(ctx context.Context, op errors.Op, script *redis.Script,
	keys []string, args ...any) error {
...
func (r *RDB) runScriptWithErrorCode(ctx context.Context, op errors.Op, script *redis.Script,
	keys []string, args ...any) (int64, error) {
...
func (r *RDB) AddToGroupUnique(ctx context.Context, msg *base.TaskMessage,
	uniqueKey, groupKey string, ttl time.Duration) error {
...
func (r *RDB) Retry(ctx context.Context, msg *base.TaskMessage,
...
func (r *RDB) AggregationCheck(qname, gname string, t time.Time,
	gracePeriod, maxDelay time.Duration, maxSize int) (string, error) {
