...
func (c FacadeConfig) Validate() error {
	...
	if c.CommandsEnabled() {
		if c.GenerateCommandsTopic == nil {
			err = multierr.Append(err, errors.New("GenerateCommandsTopic is nil"))
		}
		if c.CommandsSubscriberConstructor == nil {
			err = multierr.Append(err, errors.New("CommandsSubscriberConstructor is nil"))
		}
		if c.CommandsPublisher == nil {
			err = multierr.Append(err, errors.New("CommandsPublisher is nil"))
		}
	}
	if c.EventsEnabled() {
		if c.GenerateEventsTopic == nil {
			err = multierr.Append(err, errors.New("GenerateEventsTopic is nil"))
		}
		if c.EventsSubscriberConstructor == nil {
			err = multierr.Append(err, errors.New("EventsSubscriberConstructor is nil"))
		}
		if c.EventsPublisher == nil {
			err = multierr.Append(err, errors.New("EventsPublisher is nil"))
		}
	}

	if c.Router == nil {
		err = multierr.Append(err, errors.New("Router is nil"))
	}
	if c.Logger == nil {
		err = multierr.Append(err, errors.New("Logger is nil"))
	}
	if c.CommandEventMarshaler == nil {
		err = multierr.Append(err, errors.New("CommandEventMarshaler is nil"))
	}
