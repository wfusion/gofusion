...
const (
	ContextKeyMessageUUID  = "watermill:message_uuid"
	ContextKeyRawMessageID = "watermill:raw_message_id"
	ContextLogFieldKey     = "watermill:context"
	MessageRouterAck       = "watermill:router_ack"
	MessageHeaderAppID     = "appid"
)
