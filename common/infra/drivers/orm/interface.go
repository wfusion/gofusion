...
type Option struct {
	...
	ReadTimeout     utils.Duration `yaml:"read_timeout" json:"read_timeout" toml:"read_timeout" default:"2s"`
	WriteTimeout    utils.Duration `yaml:"write_timeout" json:"write_timeout" toml:"write_timeout" default:"2s"`
	...
	ConnMaxLifeTime utils.Duration `yaml:"conn_max_life_time" json:"conn_max_life_time" toml:"conn_max_life_time" default:"30m"`
	ConnMaxIdleTime utils.Duration `yaml:"conn_max_idle_time" json:"conn_max_idle_time" toml:"conn_max_idle_time" default:"15m"`
}
