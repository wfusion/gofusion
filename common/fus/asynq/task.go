...
func init() {
	...
	utils.MustSuccess(taskListCmd.MarkFlagRequired("queue"))
	utils.MustSuccess(taskListCmd.MarkFlagRequired("state"))
	...
	utils.MustSuccess(taskInspectCmd.MarkFlagRequired("queue"))
	utils.MustSuccess(taskInspectCmd.MarkFlagRequired("id"))
	...
	utils.MustSuccess(taskArchiveCmd.MarkFlagRequired("queue"))
	utils.MustSuccess(taskArchiveCmd.MarkFlagRequired("id"))
	...
	utils.MustSuccess(taskDeleteCmd.MarkFlagRequired("queue"))
	utils.MustSuccess(taskDeleteCmd.MarkFlagRequired("id"))
	...
	utils.MustSuccess(taskRunCmd.MarkFlagRequired("queue"))
	utils.MustSuccess(taskRunCmd.MarkFlagRequired("id"))
	...
	utils.MustSuccess(taskArchiveAllCmd.MarkFlagRequired("queue"))
	utils.MustSuccess(taskArchiveAllCmd.MarkFlagRequired("state"))
	...
	utils.MustSuccess(taskDeleteAllCmd.MarkFlagRequired("queue"))
	utils.MustSuccess(taskDeleteAllCmd.MarkFlagRequired("state"))
	...
	utils.MustSuccess(taskRunAllCmd.MarkFlagRequired("queue"))
	utils.MustSuccess(taskRunAllCmd.MarkFlagRequired("state"))
