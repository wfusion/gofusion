...
func TestGoMonkey(t *testing.T) {
	t.Parallel()
	testingSuite := &GoMonkey{Test: new(testUtl.Test)}
...
func (t *GoMonkey) BeforeTest(suiteName, testName string) {
	t.Catch(func() {
		log.Info(context.Background(), "right before %s %s", suiteName, testName)
	})
}

func (t *GoMonkey) AfterTest(suiteName, testName string) {
	t.Catch(func() {
		log.Info(context.Background(), "right after %s %s", suiteName, testName)
	})
}

//func (t *GoMonkey) TestApplyFuncReturn() {
//	t.Catch(func() {
//		info1 := "hello cpp"
//
//		patches := gomonkey.ApplyFuncReturn(ReadLeaf, info1, nil)
//		defer patches.Reset()
//
//		for i := 0; i < 10; i++ {
//			output, err := ReadLeaf("")
//			t.NoError(err)
//			t.Equal(info1, output)
//		}
//
//		patches.Reset() // if not reset will occur:patch has been existed
//		info2 := "hello golang"
//		patches.ApplyFuncReturn(ReadLeaf, info2, nil)
//		for i := 0; i < 10; i++ {
//			output, err := ReadLeaf("")
//			t.NoError(err)
//			t.Equal(info2, output)
//		}
//	})
//}
